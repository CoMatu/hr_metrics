...
// барчарт с разделением внутри бара, высота как сумма значений
...
class StackedBarChart extends StatefulWidget {
  ...
  StackedBarChart(this.seriesList, this.units, {this.animate});

  @override
  StackedBarChartState createState() {
    return StackedBarChartState();
  }
